...
def generate_diagram_image():
    ...
    png_file = r'd:\Nexora AI\architecture_diagram.png'
    artifact_png = r'C:\Users\USER\.gemini\antigravity-ide\brain\325838f2-daf1-4a87-a834-812c74475fcf\architecture_diagram.png'
...
"""
    ...
    print("Diagram HTML written:", html_file)
    ...
    if os.path.exists(png_file):
        ...
        print("ERROR: Image was not generated.")
